...
<div>
    <x-bread-cumb title="Details projets" />
            ...
            <div class="grid grid-cols-12 gap-4">
                <div class="col-span-12 lg:col-span-8">
                    <div class="project-details__content">
                        <h2 class="text-4xl project-details__title">Where Innovation Meets Interior Design</h2>
                    ...
                    <div class="project-sidebar__box">
                        <ul class="project-sidebar">
                            <li class="project-sidebar__item">
                                ...
                                <h6 class="mb-0 font-semibold project-sidebar__title font-16">Sandi leo rakiul</h6>
                            </li>
                            <li class="project-sidebar__item">
                                <span class="project-sidebar__text font-12">150000 USD</span>
                                <h6 class="mb-0 font-semibold project-sidebar__title font-16">consultation real estate </h6>
                            </li>
                            <li class="project-sidebar__item">
                                <span class="project-sidebar__text font-12">Category</span>
                                <h6 class="mb-0 font-semibold project-sidebar__title font-16">Planing, Real Estate</h6>
                            </li>
                            <li class="project-sidebar__item">
